...
export default class SignUpForm extends Component {
  ...
  render() {
    const startView = (
      <>
        <Box className="signup-container">
          <Typography variant="h3" align="center" className="console-header">
            Welcome
          </Typography>
          <Typography align="center" variant="h2">
            Kitabu is a place to donate your gently used children's books.
            <br />
            Each book you donate contributes to a library in rural Africa.{" "}
            <br />1 Kitabu (1k, or 1,000 books) = 1 library
          </Typography>
    ...
    const emailView = (
      <Box className="signup-container">
        <Typography variant="h2" align="center" className="console-header">
          You said {this.state.user.name}
        </Typography>
        <Typography variant="h1" align="center" className="console-header">
          Hi, {this.state.user.name}! Where can we reach you?
        </Typography>
        <TextField
          id="email"
          name="email"
    ...
    const locationView = (
      <Box className="signup-container">
        <Typography variant="h2" align="center" className="console-header">
          You said {this.state.user.email}
        </Typography>
        <Typography variant="h1" align="center" className="console-header">
          Where are you from?
        </Typography>
    ...
    const typeView = (
      <Box className="signup-container">
        <Typography variant="h2" align="center" className="console-header">
          You said {this.state.user.area}
        </Typography>
        <Typography variant="h1" align="center" className="console-header">
          Are you a donor, or collector?
        </Typography>
        <Typography variant="h2" align="center" className="console-header">
          Now choose if you would like to donate books, or become a partnered
          collector (collectors host book drives)
        </Typography>
        <RadioGroup
        ...
        <div className="form-controls">
          ...
          >
            {this.state.user.type !== "Collector"
              ? "Almost Done"
              : "Additional Details"}
          </Button>
        </div>
    ...
    const additionalInfoView = (
      <Box className="signup-container">
        <Typography variant="h2" align="center" className="console-header">
          You said {this.state.user.type}
        </Typography>
        <Typography variant="h1" align="center" className="console-header">
          We just need a few more details...
        </Typography>
        <Typography variant="h2" align="center" className="console-header">
          We collect this information to make it easier for people to find your
          book drive
        </Typography>
        <Box mx="auto" w={0.88}>
          <TextField
          ...
          <Box my={2}>
            <Typography fullWidth variant="h2" align="center">
              When are you available for donations?
              <br />
        ...
        <Box className="signup-container">
          ...
          <div className="form-controls">
            ...
            <Button
              ...
              disabled={
                this.state.user.password !== this.state.user.confirmPass
                  ? true
                  : false
              }
            >
      ...
      <>
        <Box className="signup-container">
          ...
          <div className="form-controls">
            <Link
              className="link"
              to={this.state.user.type === "Donor" ? "/donate" : "/partners"}
            >
