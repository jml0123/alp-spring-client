  ...
  return (
    <>
      ...
      >
          ...
          >
            ...
            <Box
                m={2.33}
            >
                <h4 className="slide-desc">Earn points to buy products and help literacy rates in Africa</h4>
            </Box>
          </Box>
      </Box>
      <Box
      ...
      >
          ...
          <img src={bookdrive}></img>
          <p className="more-info">Kitabu is part of African Library Project, which seeks to changes lives book by book by starting libraries in Africa. 
